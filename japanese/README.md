---
original: ada9cfd644b3c7716a076d33326ca5cc52a408ac3a913cb00f3cd43f5c28e1f2
---
...
NIPsは**Nostr実装の可能性**（Nostr Implementation Possibilities）を意味します。
...
- [NIP-10: テキストイベントでのクライアントによる`e`タグと`p`タグの使用規則](10.md)
...
これらの2つの標準化方法は、このリポジトリでサポートされています。2つ目の方法が好ましいですが、このリポジトリ外で生まれた標準を、後で他の人が容易に理解し実装できるNIPとして成文化する努力がなされます - ただし、明らかに人間のシステムと同様に、標準が有害であると考えられる場合には裁量が適用される可能性があります。
